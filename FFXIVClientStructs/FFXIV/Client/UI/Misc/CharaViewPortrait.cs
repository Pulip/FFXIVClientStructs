...
public unsafe partial struct CharaViewPortrait {
    ...
    [MemberFunction("E8 ?? ?? ?? ?? 0F B7 4F ?? E8 ?? ?? ?? ?? 0F B7 4F ?? 0F 28 F0 E8 ?? ?? ?? ?? 0F 28 C8 0F 28 D6 48 8B CB E8 ?? ?? ?? ?? 44 0F B6 4F ?? 48 8B CB 44 0F B6 47 ?? 0F B6 57 ?? E8 ?? ?? ?? ?? 48 8B 4B ?? 0F B6 47 ?? F3 0F 10 35 ?? ?? ?? ?? 48 8B 74 24")]
